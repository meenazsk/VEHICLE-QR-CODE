...
if(isset($_POST['submit']))
{
    ...
    $v11=$_POST['f11'];
    $v12=$_POST['f12'];
    $sql=mysqli_query($conn,"INSERT INTO driving_licence VALUES('$v1','$v2','$v3','$v4','$v5','$v6','$v7','$v8','$v9','$v10','$v11','$v12')");
    if($sql)
    {
        echo "data inserted";
    }
  ...
  <section class="about_section layout_padding">
    ...
    <center>
		<form method="post"><br>
			...
			<label>UserMobilenumber:</label><br>
			...
			<label>LicenceNumber:</label><br>
			<input type="text" name="f9"><br><br>
			<label>Age:</label><br>
			<input type="text" name="f10"><br><br>
			<label>IssuedDate:</label><br>
			<input type="text" name="f11"><br><br>
			<label>ExpiredDate:</label><br>
			<input type="text" name="f12"><br><br>
