...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($conn,"INSERT INTO emission_testing VALUES('$v1','$v2','$v3','$v4','$v5','$v6')");
    if($sql)
    {
        echo "data inserted";
    }
...
<!-- about section -->
  ...
  <section class="about_section layout_padding">
    ...
    <center>
		<form method="post"><br>
			<h3><label>Emission Testing</label><br><br></h3>
			...
			<label>VehicleCondition:</label><br>
			<input type="text" name="f4"><br><br>
			<label>CarbonValue:</label><br>
