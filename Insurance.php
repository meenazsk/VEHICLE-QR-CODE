...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($conn,"INSERT INTO vehicle_Insurance VALUES('$v1','$v2','$v3','$v4','$v5','$v6','$v7','$v8')");
    if($sql)
    {
        echo "data inserted";
    }
...
<!-- about section -->
  ...
  <section class="about_section layout_padding">
    ...
    <center>
		<form method="post"><br>
			<h3><label>Vehicle Insurance</label><br><br></h3>
